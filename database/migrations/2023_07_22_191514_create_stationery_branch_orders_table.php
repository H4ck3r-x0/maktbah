...
return new class extends Migration
{
    ...
    {
        Schema::create('stationery_branch_orders', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('user_id');
            $table->unsignedBigInteger('note_id');
            $table->unsignedBigInteger('stationery_branch_id');
    ...
    {
        Schema::dropIfExists('stationery_branch_orders');
    }
};
