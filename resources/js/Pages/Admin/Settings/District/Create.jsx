        ...
        <AdminAuthenticatedLayout
            ...
            header={
                <div className='flex items-center justify-between'>
                    <h2 className="font-semibold text-xl text-gray-800 leading-tight">إضافة احياء</h2>
                </div>
            }
        >
            <Head title="إضافة احياء" />
                                ...
                                <table className={`w-full text-sm text-right text-gray-500 border ${processing ? 'opacity-25 transition-opacity' : ''}`}>
                                    ...
                                    <tbody>
                                        {districts.map(district => (
                                            <tr className="bg-white border-b hover:bg-gray-100 hover:transition-all" key={district.id}>
                                                ...
                                                <td className="px-0 py-4">
                                                    <div className='flex items-center gap-2'>
                                                        <Link href={route('admin.district.edit', district.id)}>
                                                            <PrimaryButton>
