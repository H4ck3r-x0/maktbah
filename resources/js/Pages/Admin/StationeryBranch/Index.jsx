...
export default function Index({ auth, stationeries, cities, districts }) {
    ...
    const deletestationery = (id) => {
        const confirmDelete = window.confirm('هل انت متاكد من حذف القرطاسية؟ ستخسر جميع البيانات');
        if (confirmDelete === true) {
            destroy(route('admin.stationery.index', id));
        }
    }
                    ...
                    <div className='py-3'>
                        <div className='flex items-center gap-4'>
                            <TextInput
                                ...
                                autoComplete="search"
                                onChange={search}
                                placeholder="أبحث بإسم القرطاسية او صاحبها"
                            />
                                            ...
                                            <tr className="bg-white border-b hover:bg-gray-100 hover:transition-all" key={library.id}>
                                                ...
                                                {/* <td className="px-0 py-4" id='here'>
                                                    <div className='flex items-center gap-2'>
                                                        ...
                                                        <DangerButton onClick={() => deletestationery(library.id)} disabled={processing}>
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
