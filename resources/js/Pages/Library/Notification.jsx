                                    ...
                                    <div key={notification.id} className='bg-white flex items-center justify-between gap-3 p-6 shadow-md rounded-md'>
                                        <div className='flex items-center gap-3'>
                                            ...
                                            <div className='flex flex-col gap-1'>
                                                <h1 className='text-lg text-gray-600'>{notification.data.message}</h1>
                                                <span className='text-sm text-indigo-600 font-simibold'>
                                                    {moment(notification.data.created_at).locale('ar').format('MMMM Do YYYY')}
                                                </span>
                                            </div>
                                        </div>
                                        <Link>
