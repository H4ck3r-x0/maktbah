...
export default function AuthenticatedBranchHeader({ user }) {
                ...
                <div className="flex justify-between h-16">
                    <div className="flex">
                        ...
                        <div className="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <NavLink href={route('branch.book.create')} active={route().current('branch.book.create')}>
                                الكتب
                            </NavLink>
                            <NavLink href={route('branch.order.index')} active={route().current('branch.order.index')}>
                                الطلبات
                            </NavLink>
                        </div>
                    </div>
                    ...
                    <div className="hidden sm:flex sm:items-center sm:ml-6">
                        <div className="flex items-center ml-3 relative">
                            ...
                            <Dropdown>
                                ...
                                <Dropdown.Content>
                                    <Dropdown.Link href={route('branch.dashboard')}>لوحة التحكم</Dropdown.Link>
